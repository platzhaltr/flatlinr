...
/**
 * The Class PreservingPredicateFunction.
 *
 * @author Oliver Schrenk <oliver.schrenk@gmail.com>
 */
public class PreservingPredicateFunction implements Function<String, String> {
	 ...
	 *            the inner function
	 */
	public PreservingPredicateFunction(final Predicate<String> predicate,
